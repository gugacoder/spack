...
public class DbConnector
{
  ...
  /// </param>
  public DbConnector(Connection[] connections)
  {
  ...
  /// </returns>
  public async Task<DbConnection> CreateConnectionAsync(Connection connection)
  {
  ...
  /// String de conexão.
  /// </returns>
  private async Task<string> GetConnectionStringAsync(ConnectionStringFactory connectionStringFactory)
  {
