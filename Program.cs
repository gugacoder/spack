...
if (help.On)
{
  ...
  using var stream = assembly.GetManifestResourceStream("HELP.info");
  if (stream == null)
  {
...
if (list.On)
{
  ...
  {
    var descendants = repository.GetDescendants<Connection>();
  ...
  {
    var descendants = repository.GetDescendants<Catalog>();
  ...
  {
    var descendants = repository.GetDescendants<Product>();
  ...
  {
    var descendants = repository.GetDescendants<Module>();
  ...
  {
    var descendants = repository.GetDescendants<Package>();
  ...
  {
    var descendants = repository.GetDescendants<Script>();
...
if (migrate.On)
{
  ...
  var connectionInstances = repository.GetDescendants<Connection>().ToArray();
  ...
  foreach (var connection in connections.Values)
  {
    ...
    connectionInstance.ConnectionStringFactory = new ConnectionStringFactory { ConnectionString = connectionString };
  }
  ...
  foreach (var migrant in migrants)
  {
    ...
    // {
    //   Console.WriteLine($"Migrando {e.Script.Path} para {e.Connection.Name}...");
    // };
    // migrant.OnMigrateError += (sender, e) =>
    // {
    //   Console.Error.WriteLine($"ERRO! {e.Script.Path} não pode ser migrado para {e.Connection.Name}.");
    // };
    // migrant.OnMigrateSuccess += (sender, e) =>
    // {
    //   Console.WriteLine($"SUCESSO! {e.Script.Path} foi migrado para {e.Connection.Name}.");
    // };
