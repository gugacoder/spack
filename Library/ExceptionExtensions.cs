...
{
  /// <summary>
  /// Retorna uma string com a mensagem de exceção e as mensagens de exceção interna.
  /// </summary>
  ...
  /// <summary>
  /// Retorna uma string contendo a mensagem de exceção e a pilha de chamadas dos métodos que levaram à exceção,
  ...
  /// </param>
  /// <returns>
  /// Uma string contendo a mensagem de exceção e a pilha de chamadas dos métodos que levaram à exceção,
  /// bem como as mensagens de exceção interna, se houver.
  /// </returns>
